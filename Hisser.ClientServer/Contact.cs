...
namespace Hisser.ClientServer
{
    ...
    public class Contact
    {
        ...
        /// <summary>
        /// Checks whether the given address matches this Contact's address.
        /// </summary>
        /// <param name="address">The address to compare this Contact's address with.</param>
        /// <returns>True iff the addresses match.</returns>
        public bool EqualAddress(string address)
        {
            return Username.ToLower().Equals(ParseUsername(address).ToLower());
        }
