...
namespace Hisser.ClientServer
{
    ...
    public class ContactManager
    {
        ...
        public HisserTransaction BeginTransaction()
        {
            return new HisserTransaction(this);
        }
            ...
            if (!Context.DatabaseExists())
            {
                ...
                catch (Exception)
                {
                    throw new FunctionalException(
                        "Unable to create a database to store your messages and contacts. Please make sure that SQL Server Compact Edition has been installed on your device.");
                }
            }
            else
            {
        ...
        public class HisserTransaction : IDisposable
        {
            internal ContactManager _manager;
            internal bool completed = false;

            internal HisserTransaction(ContactManager manager)
            {
