...
using Hisser.UI.Phone.ViewModels;
    ...
    public partial class App : Application
    {
        ...
        public static MainViewModel ViewModel
        {
            get
            {
                ...
                if (viewModel == null)
                {
                    string address = "";//.UsernameSetting;
                    string username = Contact.ParseUsername(address);
                    string hostname = Contact.ParseServer(address);
                    string password = "";//settings.UsernameSetting;
                    NetworkCredential credentials = new NetworkCredential(username, password);
                    string device_id = "Phone";

                    //Define database and ContactManager
                    string databaseFolder = string.Format("{0}\\Hisser", Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData));
                    ...
                    Client client = new Client(context, credentials, hostname, new Device(device_id));
                    viewModel = new MainViewModel(client, credentials, address);
                }
